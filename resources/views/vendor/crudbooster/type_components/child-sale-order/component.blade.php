...
<div class='form-group {{$header_group_class}}' id='form-group-{{$name}}'>
    ...
    @if($form['columns'])
        ...
        <div class="col-sm-10">
            ...
            <div id='panel-form-{{$name}}' class="">
                <!--<div class="panel-heading">
                    <i class='fa fa-bars'></i> {{$form['label']}}
                </div>
                <div class="panel-body">
                -->
                <div id='sale-items-id' class="modal" tabindex="-1" role="dialog">
                    <div class="modal-dialog modal-lg" role="document">
                        <div class="modal-content">
                            <div class="modal-header">
                                <button type="button" class="close" onclick="hideSaleOrderItem()" aria-label="Close"><span
                                            aria-hidden="true">&times;</span></button>
                                <h4 class="modal-title"><i
                                    class='fa fa-search'></i> Add {{$form['label']}}
                                </h4>
                            </div>
                                ...
                                <div class='row'>
                                    <div class='col-sm-12'>
                                        <!--<div class="panel panel-default">
                                            <div class="panel-heading"><i class="fa fa-pencil-square-o"></i> {{$form['label']}}</div>
                                                    ...
                                                    <button class="btn btn-primary" onclick="showModal{{$name_column}}()" type="button"><i
                                                                ...
                                                                <div id='modal-datamodal-{{$name_column}}' class="modal" tabindex="-1" role="dialog">
                                                                    <div class="modal-dialog {{ $col['datamodal_size']=='large'?'modal-lg':'' }} " role="document">
                                                                        <div class="modal-content">
                                                                            <div class="modal-header">
                                                                                <button type="button" class="close" onclick="hideModal{{$name_column}}()" aria-label="Close"><span
                                                                                            aria-hidden="true">&times;</span></button>
                                                                                <h4 class="modal-title"><i
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <i class='fa fa-table'></i> {{$form['label']}}
                            <a id='add-sale-order-item' onclick="showSaleOrderItem()" class="btn btn-success btn-sm">
                                <i class="fa fa-plus"></i> New
                            </a>
                        </div>
                        @push('bottom')
                            <script type="text/javascript">
                                function showSaleOrderItem() {
                                    $('#sale-items-id').modal('show');
                                }
                                function hideSaleOrderItem(){
                                    $('#sale-items-id').modal('hide');
                                }
                            </script>
                        @endpush
